...
function beautify(mode,element,setElement,custom_pattern) {

	var ta = document.getElementById(element),
	...
	countChars(element,setElement);
}

function minify(mode,element,preservews) {
	var ta = document.getElementById(element);
...
function countChars(element,setElement){
	document.getElementById(setElement).value = document.getElementById(element).value.length;
}